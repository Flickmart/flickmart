...
export default function MessageBubble({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'max-w-[85%] xs:max-w-[80%] rounded-lg px-2 py-1 shadow-sm sm:max-w-[75%] sm:px-3 sm:py-2 md:max-w-[65%] md:p-3',
          isUser
            ? 'rounded-br-none bg-flickmart text-white'
  ...
  return (
    <Link href={`/product/${productId}`}>
      <div className="flex justify-end">
        <div className="max-w-[280px] bg-flickmart text-white sm:max-w-xs">
          {/* Product Details Section - Highlighted */}
          <div className="mb-2 flex items-center gap-2 rounded-lg border border-orange-400 bg-orange-600 p-2 sm:mb-3 sm:gap-3 sm:p-3">
