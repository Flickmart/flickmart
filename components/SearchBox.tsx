...
export default function SearchBox({
  ...
  return (
    ...
    >
      <div className="rounded-sm bg-[#FF8100] px-2.5 py-2.5 text-white lg:rounded-l-none lg:rounded-md lg:py-2">
      ...
      <div className=" bg-gray-100 h-11 w-[calc(99%-150px)] rounded-sm flex flex-col justify-center lg:h-10 lg:flex lg:items-center lg:rounded-r-none lg:rounded-l-md lg:w-[calc(100%-150px)]">
        <SearchInput
          isOverlayOpen={open}
          loc={location}
