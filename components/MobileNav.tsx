        ...
        <div className="flex w-1/3 justify-between items-center">
          ...
          >
            <div className="relative">
              <Bell
                className={`${pathname === "/notifications" ? "text-flickmart" : "text-flickmart-gray"} group-hover:text-flickmart duration-500 h-5 w-5`}
              />
              {unreadCount > 0 && (
            ...
            <span
              className={`${pathname === "/notifications" ? "text-flickmart" : ""} group-hover:text-flickmart duration-500`}
            >
              Notifications
            </span>
          </Link>
