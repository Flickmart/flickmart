...
export function PushNotificationTest() {
  ...
  const sendTestNotification = useMutation(api.notifications.createTestNotificationWithPush);
  ...
  const handlePermissionCheck = async () => {
    ...
    if (Notification.permission === 'default') {
      ...
      toast.success(`Current permission: ${Notification.permission}. Check console for details.`);
    }
  };
