...
export const getUserPresence = query({
  ...
  handler: async (ctx, args) => {
    ...
    const isOnline = Date.now() - presence.lastUpdated < 10000;
  ...
  handler: async (ctx, args) => {
    ...
    return {
      user1: {
        ...
        status: user1Presence && currentTime - user1Presence.lastUpdated < onlineThreshold
          ? user1Presence.status
          : "offline",
        isTyping: user1Presence?.isTyping && 
      ...
      user2: {
        ...
        status: user2Presence && currentTime - user2Presence.lastUpdated < onlineThreshold
          ? user2Presence.status
          : "offline",
        isTyping: user2Presence?.isTyping && 
