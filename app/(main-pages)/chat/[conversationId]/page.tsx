...
export default function ConversationPage() {
    ...
    const [processedProductId, setProcessedProductId] = useState<Id<"product"> | null>(null);
    ...
    const otherUserId = useMemo(() => {
        ...
        return conversation.user1 === user._id ? conversation.user2 : conversation.user1;
    ...
    const sendInitialProductMessage = useCallback(
        async (currentProductId: Id<"product">) => {
            if (!user?._id || processedProductId === currentProductId || !product || !conversationId) {
    ...
    }, [productId, product, processedProductId, sendInitialProductMessage, router, conversationId]);
