        ...
        <div className="gap-5 space-y-3 lg:grid lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center space-y-3">
            ...
            <div className="space-y-2 rounded-md bg-white p-5">
              <h3 className="font-semibold text-flickmart-orange-2 text-lg tracking-wider">
                Description
              </h3>
            ...
            >
              ...
              <Link
                ...
                href="/post-ad"
              >
                <button className="flex w-full items-center justify-center gap-10 rounded-md bg-flickmart-orange-2 py-4 font-medium text-white capitalize">
