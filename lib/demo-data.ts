...
export const demoChats = [
  ...
  export const demoMessages: Message[] = [
    ...
    },
    {
      ...
      role: "assistant",
      timestamp: new Date(Date.now() - 3600000 * 23.9),
    },
    {
      id: "b3",
      chatId: "2",
      ...
      role: "user",
      timestamp: new Date(Date.now() - 3600000 * 23.8),
    },
    {
      id: "b4",
      chatId: "2",
    ...
    },
    {
      ...
      role: "user",
      timestamp: new Date(Date.now() - 3600000 * 29),
    },
    {
      id: "w3",
      chatId: "3",
    ...
    },
    {
      ...
      role: "assistant",
      timestamp: new Date(Date.now() - 3600000 * 94),
    },
    {
      id: "f4",
      chatId: "5",
      ...
      role: "assistant",
      timestamp: new Date(Date.now() - 3600000 * 93),
    },
    {
      id: "f5",
      chatId: "5",
